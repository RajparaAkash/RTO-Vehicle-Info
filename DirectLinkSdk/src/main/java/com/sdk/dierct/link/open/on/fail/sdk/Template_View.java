...
public class Template_View extends FrameLayout {
    ...
    public Template_View(Context context) {
        super(context);
    }

    public Template_View(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public Template_View(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    @SuppressLint("NewApi")
    public Template_View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        initView(context, attrs);
    }

    public void setStyles(NativeTemplate_Style styles) {
        this.styles = styles;
        this.applyStyles();
    }
    ...
    public void updateTextColor(View child) {
        String b = new Apps_Preference(getContext()).getTextColor();
    ...
    public void updateBg() {
        Apps_Preference preference = new Apps_Preference(getContext());
