...
public class VehicleDetails implements Serializable {
    ...
    public int identifyVehicleType() {
        return Utils.isNullOrEmpty(this.vehicleClass) ? R.drawable.ic_placeholder_car : (this.vehicleClass.equalsIgnoreCase("MCYL") || this.vehicleClass.equalsIgnoreCase("MOTOR CYCLE") || this.vehicleClass.toLowerCase().contains("m-cycle") || this.vehicleClass.toLowerCase().contains("scooter") || this.vehicleClass.toLowerCase().contains("moped")) ? R.drawable.ic_placeholder_bike : this.vehicleClass.toLowerCase().contains("three wheeler") ? R.drawable.ic_placeholder_auto : (this.vehicleClass.contains("LMV") || this.vehicleClass.equalsIgnoreCase("motor car") || this.vehicleClass.equalsIgnoreCase("motor cab")) ? R.drawable.ic_placeholder_car : this.vehicleClass.equalsIgnoreCase("bus") ? R.drawable.ic_placeholder_bus : (this.vehicleClass.toLowerCase().contains("goods carrier") || this.vehicleClass.equalsIgnoreCase("HEAVY GOODS VEHICLE")) ? R.drawable.ic_placeholder_truck : R.drawable.ic_placeholder_car;
    }
