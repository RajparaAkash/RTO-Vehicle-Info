...
public class ExtaScreen2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_exta_screen_2);

        findViewById(R.id.extra_screen_2_txt).setOnClickListener(view -> {
            new InterAds().ShowfuullAd(this, new AdClosedListener() {
                @Override
                public void AdisClosed() {
                    startActivity(new Intent(ExtaScreen2Activity.this, ExtaScreen3Activity.class));
                }
            });
        });
    }
