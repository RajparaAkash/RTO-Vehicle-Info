...
public class ExternalVehicleDetails {
    ...
    public VehicleDetails convertInto() {
        String encodePrivateString = !Utils.isNullOrEmpty(this.chassisNo) ? encodePrivateString(this.chassisNo) : "";
        String encodePrivateString2 = Utils.isNullOrEmpty(this.engineNo) ? "" : encodePrivateString(this.engineNo);
